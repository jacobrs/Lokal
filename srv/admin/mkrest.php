...
<html>
	<head>
		...
		<form 	name = "addfrm" action = "<?php echo $pathToRoot;?>srv/admin/addrest.php" method = "POST"
			...
			<p class="emailInfo" style="rgba(0, 0, 0, 0); color:#FFFFFF">Make A New Restaurant</p>
			...
			<div class = "row">
				<div class = "large-15 medium-15 columns" id = "emailDiv">
			...
			<div class = "row">
				<div class = "large-7 medium-7 columns" id = "passwd">
				...
				<div class = "large-7 medium-7 columns" id = "rpasswd">
			...
			<div class = "large-15 medium-15 small-15 columns" id = "addbtnd">
				 <a onclick="document.getElementById('addfrm').submit();" style="margin-top:12px; text-align:center;"
					class="button small expand" id="emailBtn">Insert</a>
			</div>
			</fieldset>
		</form>
		<script>
